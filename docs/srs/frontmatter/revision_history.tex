...
revision adding no requirement and withdrawing none, but narrowing two
stable ones to what the code can actually deliver. REQ-41 promised GUM
...
\code{set\_correlation}. REQ-36's non-differentiability guard extends
