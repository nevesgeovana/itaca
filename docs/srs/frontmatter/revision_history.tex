...
revision adding no requirement and withdrawing none, but narrowing FIVE
stable ones to what the code can actually deliver: REQ-41 and REQ-36 on
the engine itself, and REQ-98, REQ-99 and REQ-100 on the operations whose
behavior changed with it. REQ-41 promised GUM
...
transfer per frame while uncertainty is present. "Exact within one
