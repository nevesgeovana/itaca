...
and withdrawing none, correcting REQ-83. The table had drifted in both
...
\code{ruff} where \code{pyproject.toml} carries the exact pin REQ-96
requires, and carried five rows for packages declared in no extra at
all. That last group is why the roles are now split: a \code{planned}
