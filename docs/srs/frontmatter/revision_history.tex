...
six more public refusals whose requirement text did not describe them,
...
(\code{R3-ITA-008}), and that a CSV row wider than its header is refused
while a row narrower than it is still NaN-filled, the asymmetry being
given its reason rather than left for a reader to infer
(\code{R3-ITA-009}, \code{ITC-20260729-2255}, found by REV-004 after the
first five were closed). REQ-24 and REQ-107 state the \code{itc.concat}
