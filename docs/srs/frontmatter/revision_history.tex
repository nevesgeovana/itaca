...
where it was wrong: Section~ef{sec:itc-pipe} now specifies the \code{.itc\_pipe}
serialization as JSON rather than TOML, with the reasons recorded in
...
archive at schema \code{itaca-itc/2}.\\
\addlinespace
