...
list, which was complete when the carve-out was written and was already

false by the time the release closed, the CHK-1 checkpoint having

turned several further accepted inputs into public refusals. A
