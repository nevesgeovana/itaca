...
stated rather than left implicit because \code{0.2.0} ships three:

the Python floor rising to 3.11, pre-0.2.0 \itc{} archives carrying

metadata no longer verifying under the widened REQ-103 scope (DD-40),

and a \code{[constants]} name colliding with a measured channel now

being refused (DD-39). Under the rule above and no carve-out, that

release would be non-conforming, and the requirement rather than the

release is what was wrong.
