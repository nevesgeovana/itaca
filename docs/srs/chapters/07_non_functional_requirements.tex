...
does not block the push. What keeps it a routing decision rather than an
exemption is that a red CI now blocks the lane CLOSING, through
\code{.claude/tools/closing\_ci\_check.py} (INC-20260811-1745-itaca). The
mirror claim in this requirement was itself proven incomplete by
