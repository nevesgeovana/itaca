...
and the requirement states the ONE exemption rather than leaving it to
be discovered: REQ-36 admits any \code{np.*} function into an expression
carrying no uncertainty, a reduction reads cells other than its own, and
confining such a tree would change the value of the reduction itself.
