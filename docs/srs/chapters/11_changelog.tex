...
Worth recording beside it, because it shows the shape of the eventual
fix: \code{db.rotate} faces the same situation and DOES record what it
induces, writing an ordinary declared pair between the rotated
components, so a later \code{compute} over them propagates correctly and
is not refused. Whether \code{translate\_moments} should do likewise,
which would remove this refusal rather than document it, is OQ-51.
