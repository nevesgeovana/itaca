...
and STYLE; SECTION COMPLETENESS on the declared public surface is
enforced by \code{tests/test\_docstring\_sections.py} (REQ-79), not by
linting. An earlier revision claimed linting enforced the sections,
