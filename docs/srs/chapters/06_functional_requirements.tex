...
never derived. It arises from a non-replayable record: a
\code{combine}, or a schema-1 archive whose entries were restored
without their replay steps. The message says which operation could not
