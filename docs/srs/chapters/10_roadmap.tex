...
REQ-31, REQ-32 & \code{fitmodel}, \code{fitvalue} & \code{ops/fitmodel.py}\\
...
Catalog system         & Session-level catalog (\code{itc.catalog}) tracking all saved VarFrame objects, enabling version comparison, lineage graphs, and dataset discovery.\\
