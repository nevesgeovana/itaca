...
side-effects: creates and removes review worktrees; writes findings and a round ledger under the management root; WRITES THE PUSH-GATE ATTESTATION, which is what authorizes a push
---
